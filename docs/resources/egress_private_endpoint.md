...
description: |-
  ...
  Warning: Use of egress private endpoints requires >=v1.14.0
  ...
  Terraform resource docs https://github.com/cockroachdb/terraform-provider-cockroach/blob/main/docs/resources/egress_private_endpoint.mdCockroach Cloud docs https://www.cockroachlabs.com/docs/cockroachcloud/egress-private-endpoints.html
---
...
- `endpoint_connection_id` (String) endpoint_connection_id is the cloud-specific id for egress private endpoints. This connection ID is visible in CRL and CSP consoles as "VPC endpoint ID" and is used to uniquely identify the endpoint in external configurations
