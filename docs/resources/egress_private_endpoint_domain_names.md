...
subcategory: ""
description: |-
  Custom domain names for an egress private endpoint in a CockroachDB Cloud cluster. Custom domain names will resolve within your cluster to the endpointaddress of the given egress private endpoint.
...
Custom domain names for an egress private endpoint in a CockroachDB Cloud cluster. Custom domain names will resolve within your cluster to the endpoint_address of the given egress private endpoint.
...
- `endpoint_id` (String) endpoint_id is the UUID value of the egress private endpoint in CockroachDB Cloud.
