...
var maintenanceWindowAttributes = map[string]schema.Attribute{
	...
	"offset_duration_seconds": schema.Int64Attribute{
		Required:            true,
	...
	"window_duration_seconds": schema.Int64Attribute{
		Required:            true,
...
func (r *maintenanceWindowResource) Read(
	...
	// API returns the JSON mapping of Google's duration protobuf.
	//
	...
	state.OffsetDurationSeconds = basetypes.NewInt64Value(int64(offsetDuration))
	state.WindowDurationSeconds = basetypes.NewInt64Value(int64(windowDuration))
...
func (r *maintenanceWindowResource) setMaintenanceWindow(
	...
	// API expects the JSON mapping of Google's duration protobuf.
	//
	// https://pkg.go.dev/google.golang.org/protobuf/types/known/durationpb#hdr-JSON_Mapping.
	clientMaintenanceWindow := client.NewMaintenanceWindowWithDefaults()
	clientMaintenanceWindow.OffsetDuration = fmt.Sprintf("%ds", maintenanceWindow.OffsetDurationSeconds.ValueInt64())
	clientMaintenanceWindow.WindowDuration = fmt.Sprintf("%ds", maintenanceWindow.WindowDurationSeconds.ValueInt64())
