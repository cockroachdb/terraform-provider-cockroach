...
func TestIntegrationServiceAccountResource(t *testing.T) {
	...
	// Called by first update, description not included in resource so we don't
	// send it as part of the patch.
...
func testServiceAccountResource(t *testing.T, serviceAccountName string, useMock bool) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Empty description create sends empty string.
			{
