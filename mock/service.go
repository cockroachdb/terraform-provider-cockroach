...
// Source: github.com/cockroachdb/cockroach-cloud-sdk-go/v7/pkg/client (interfaces: Service)
...
import (
	...
	client "github.com/cockroachdb/cockroach-cloud-sdk-go/v7/pkg/client"
...
func (m *MockService) UpdateJWTIssuer(arg0 context.Context, arg1 string, arg2 *client.UpdateJWTIssuerRequest) (*client.JWTIssuer, *http.Response, error) {
	m.ctrl.T.Helper()
