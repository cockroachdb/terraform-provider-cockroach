...
type CreateClusterSpecification struct {
	...
	Shared   *SharedClusterCreateSpecification `json:"shared,omitempty"`
}
...
func (o *CreateClusterSpecification) GetShared() SharedClusterCreateSpecification {
	if o == nil || o.Shared == nil {
		var ret SharedClusterCreateSpecification
		return ret
	}
	return *o.Shared
}

// SetShared gets a reference to the given SharedClusterCreateSpecification and assigns it to the Shared field.
