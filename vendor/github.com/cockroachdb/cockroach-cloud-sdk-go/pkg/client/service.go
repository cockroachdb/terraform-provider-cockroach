...
type Service interface {
	...
	GetFolderTopLevel(ctx _context.Context, options *GetFolderTopLevelOptions) (*FolderResourceList, *_nethttp.Response, error)
...
// GetFolderTopLevelOptions contains optional parameters for GetFolderTopLevel.
type GetFolderTopLevelOptions struct {
	PaginationPage *string
...
// GetFolderTopLevel executes the request.
func (a *ServiceImpl) GetFolderTopLevel(
	ctx _context.Context, options *GetFolderTopLevelOptions,
	...
	localVarPath := localBasePath + "/api/v1/folders/top-level"
