...
const (
	...
	AUDITLOGACTION_CREATE_PLAN_MIGRATION                   AuditLogAction = "AUDIT_LOG_ACTION_CREATE_PLAN_MIGRATION"
	AUDITLOGACTION_CANCEL_PLAN_MIGRATION                   AuditLogAction = "AUDIT_LOG_ACTION_CANCEL_PLAN_MIGRATION"
	AUDITLOGACTION_CUTOVER_PLAN_MIGRATION                  AuditLogAction = "AUDIT_LOG_ACTION_CUTOVER_PLAN_MIGRATION"
	AUDITLOGACTION_CREATE_EGRESS_PRIVATE_ENDPOINT          AuditLogAction = "AUDIT_LOG_ACTION_CREATE_EGRESS_PRIVATE_ENDPOINT"
	AUDITLOGACTION_DELETE_EGRESS_PRIVATE_ENDPOINT          AuditLogAction = "AUDIT_LOG_ACTION_DELETE_EGRESS_PRIVATE_ENDPOINT"
	AUDITLOGACTION_UPDATE_EGRESS_PRIVATE_ENDPOINT          AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_EGRESS_PRIVATE_ENDPOINT"
	AUDITLOGACTION_CREATE_PHYSICAL_REPLICATION_STREAM      AuditLogAction = "AUDIT_LOG_ACTION_CREATE_PHYSICAL_REPLICATION_STREAM"
	AUDITLOGACTION_FAILOVER_PHYSICAL_REPLICATION_STREAM    AuditLogAction = "AUDIT_LOG_ACTION_FAILOVER_PHYSICAL_REPLICATION_STREAM"
	AUDITLOGACTION_CANCEL_PHYSICAL_REPLICATION_STREAM      AuditLogAction = "AUDIT_LOG_ACTION_CANCEL_PHYSICAL_REPLICATION_STREAM"
	AUDITLOGACTION_CREATE_CLUSTER_BLACKOUT_WINDOW          AuditLogAction = "AUDIT_LOG_ACTION_CREATE_CLUSTER_BLACKOUT_WINDOW"
	AUDITLOGACTION_UPDATE_CLUSTER_BLACKOUT_WINDOW          AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_CLUSTER_BLACKOUT_WINDOW"
	AUDITLOGACTION_DELETE_CLUSTER_BLACKOUT_WINDOW          AuditLogAction = "AUDIT_LOG_ACTION_DELETE_CLUSTER_BLACKOUT_WINDOW"
	AUDITLOGACTION_START_FAULT_TOLERANCE_DEMO              AuditLogAction = "AUDIT_LOG_ACTION_START_FAULT_TOLERANCE_DEMO"
	AUDITLOGACTION_END_FAULT_TOLERANCE_DEMO                AuditLogAction = "AUDIT_LOG_ACTION_END_FAULT_TOLERANCE_DEMO"
	AUDITLOGACTION_UPDATE_CLUSTER_DISRUPTION               AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_CLUSTER_DISRUPTION"
	AUDITLOGACTION_SET_CLUSTER_SETTING                     AuditLogAction = "AUDIT_LOG_ACTION_SET_CLUSTER_SETTING"
	AUDITLOGACTION_EVICT_BYOC_CLUSTER                      AuditLogAction = "AUDIT_LOG_ACTION_EVICT_BYOC_CLUSTER"
	AUDITLOGACTION_MCP_OAUTH_CONSENT                       AuditLogAction = "AUDIT_LOG_ACTION_MCP_OAUTH_CONSENT"
	AUDITLOGACTION_ENABLE_MFA_ENFORCEMENT                  AuditLogAction = "AUDIT_LOG_ACTION_ENABLE_MFA_ENFORCEMENT"
	AUDITLOGACTION_DISABLE_MFA_ENFORCEMENT                 AuditLogAction = "AUDIT_LOG_ACTION_DISABLE_MFA_ENFORCEMENT"
	AUDITLOGACTION_RESET_USER_MFA                          AuditLogAction = "AUDIT_LOG_ACTION_RESET_USER_MFA"
	AUDITLOGACTION_ENROLL_USER_MFA                         AuditLogAction = "AUDIT_LOG_ACTION_ENROLL_USER_MFA"
	AUDITLOGACTION_REGENERATE_RECOVERY_CODES               AuditLogAction = "AUDIT_LOG_ACTION_REGENERATE_RECOVERY_CODES"
	AUDITLOGACTION_CREATE_MIGRATION_ASSISTANT              AuditLogAction = "AUDIT_LOG_ACTION_CREATE_MIGRATION_ASSISTANT"
	AUDITLOGACTION_DELETE_MIGRATION_ASSISTANT              AuditLogAction = "AUDIT_LOG_ACTION_DELETE_MIGRATION_ASSISTANT"
	AUDITLOGACTION_UPDATE_BACKUP_CONFIGURATION             AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_BACKUP_CONFIGURATION"
	AUDITLOGACTION_ADD_DISPOSABLE_EMAIL_OVERRIDE           AuditLogAction = "AUDIT_LOG_ACTION_ADD_DISPOSABLE_EMAIL_OVERRIDE"
	AUDITLOGACTION_REMOVE_DISPOSABLE_EMAIL_OVERRIDE        AuditLogAction = "AUDIT_LOG_ACTION_REMOVE_DISPOSABLE_EMAIL_OVERRIDE"
	AUDITLOGACTION_CREATE_SA_CREDENTIAL                    AuditLogAction = "AUDIT_LOG_ACTION_CREATE_SA_CREDENTIAL"
	AUDITLOGACTION_DELETE_SA_CREDENTIAL                    AuditLogAction = "AUDIT_LOG_ACTION_DELETE_SA_CREDENTIAL"
	AUDITLOGACTION_CREATE_AEGIS_CONNECTOR                  AuditLogAction = "AUDIT_LOG_ACTION_CREATE_AEGIS_CONNECTOR"
	AUDITLOGACTION_UPDATE_MIGRATION_ASSISTANT_CA           AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_MIGRATION_ASSISTANT_CA"
	AUDITLOGACTION_DELETE_MIGRATION_ASSISTANT_CA           AuditLogAction = "AUDIT_LOG_ACTION_DELETE_MIGRATION_ASSISTANT_CA"
	AUDITLOGACTION_CREATE_VIRTUAL_CLUSTER_WORKSPACE        AuditLogAction = "AUDIT_LOG_ACTION_CREATE_VIRTUAL_CLUSTER_WORKSPACE"
	AUDITLOGACTION_UPDATE_VIRTUAL_CLUSTER_WORKSPACE        AuditLogAction = "AUDIT_LOG_ACTION_UPDATE_VIRTUAL_CLUSTER_WORKSPACE"
	AUDITLOGACTION_DELETE_VIRTUAL_CLUSTER_WORKSPACE        AuditLogAction = "AUDIT_LOG_ACTION_DELETE_VIRTUAL_CLUSTER_WORKSPACE"
)
...
var AllowedAuditLogActionEnumValues = []AuditLogAction{
	...
	"AUDIT_LOG_ACTION_UPDATE_BACKUP_CONFIGURATION",
	"AUDIT_LOG_ACTION_ADD_DISPOSABLE_EMAIL_OVERRIDE",
	"AUDIT_LOG_ACTION_REMOVE_DISPOSABLE_EMAIL_OVERRIDE",
	"AUDIT_LOG_ACTION_CREATE_SA_CREDENTIAL",
	"AUDIT_LOG_ACTION_DELETE_SA_CREDENTIAL",
	"AUDIT_LOG_ACTION_CREATE_AEGIS_CONNECTOR",
	"AUDIT_LOG_ACTION_UPDATE_MIGRATION_ASSISTANT_CA",
	"AUDIT_LOG_ACTION_DELETE_MIGRATION_ASSISTANT_CA",
	"AUDIT_LOG_ACTION_CREATE_VIRTUAL_CLUSTER_WORKSPACE",
	"AUDIT_LOG_ACTION_UPDATE_VIRTUAL_CLUSTER_WORKSPACE",
	"AUDIT_LOG_ACTION_DELETE_VIRTUAL_CLUSTER_WORKSPACE",
}
