...
type ClusterConfig struct {
	...
	Host       *HostClusterConfig       `json:"host,omitempty"`
	Serverless *ServerlessClusterConfig `json:"serverless,omitempty"`
	Virtual    *VirtualClusterConfig    `json:"virtual,omitempty"`
}
...
func (o *ClusterConfig) GetHost() HostClusterConfig {
	if o == nil || o.Host == nil {
		var ret HostClusterConfig
		return ret
	}
	return *o.Host
}

// SetHost gets a reference to the given HostClusterConfig and assigns it to the Host field.
...
// SetVirtual gets a reference to the given VirtualClusterConfig and assigns it to the Virtual field.
