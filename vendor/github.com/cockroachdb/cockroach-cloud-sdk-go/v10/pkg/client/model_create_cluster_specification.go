...
type CreateClusterSpecification struct {
	...
	Host                 *HostClusterCreateSpecification      `json:"host,omitempty"`
...
func (o *CreateClusterSpecification) GetHost() HostClusterCreateSpecification {
	if o == nil || o.Host == nil {
		var ret HostClusterCreateSpecification
		return ret
	}
	return *o.Host
}

// SetHost gets a reference to the given HostClusterCreateSpecification and assigns it to the Host field.
