...
// CurrencyType  - COCKROACH_CREDITS: COCKROACH_CREDITS is the same credits currency as CRDB_CLOUD_CREDITS, reported under its current name. Organizations on Continuum receive this value; all others continue to receive CRDB_CLOUD_CREDITS.
