...
// GetGroup2Body struct for GetGroup2Body.
type GetGroup2Body struct {
	Attributes         *string `json:"attributes,omitempty"`
	ExcludedAttributes *string `json:"excludedAttributes,omitempty"`
}

// NewGetGroup2Body instantiates a new GetGroup2Body object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetGroup2Body() *GetGroup2Body {
	p := GetGroup2Body{}
	return &p
}

// GetAttributes returns the Attributes field value if set, zero value otherwise.
func (o *GetGroup2Body) GetAttributes() string {
...
func (o *GetGroup2Body) SetAttributes(v string) {
	o.Attributes = &v
}

// GetExcludedAttributes returns the ExcludedAttributes field value if set, zero value otherwise.
func (o *GetGroup2Body) GetExcludedAttributes() string {
...
func (o *GetGroup2Body) SetExcludedAttributes(v string) {
