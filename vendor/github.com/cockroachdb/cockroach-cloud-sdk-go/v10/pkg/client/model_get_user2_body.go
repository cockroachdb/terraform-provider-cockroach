...
// GetUser2Body struct for GetUser2Body.
type GetUser2Body struct {
	Attributes         *string `json:"attributes,omitempty"`
	ExcludedAttributes *string `json:"excludedAttributes,omitempty"`
}

// NewGetUser2Body instantiates a new GetUser2Body object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetUser2Body() *GetUser2Body {
	p := GetUser2Body{}
	return &p
}

// GetAttributes returns the Attributes field value if set, zero value otherwise.
func (o *GetUser2Body) GetAttributes() string {
...
func (o *GetUser2Body) SetExcludedAttributes(v string) {
