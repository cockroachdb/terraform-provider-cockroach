...
// HostClusterConfig HostClusterConfig describes the hardware of a host cluster..
...
// NewHostClusterConfig instantiates a new HostClusterConfig object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHostClusterConfig(diskIops int32, machineType string, memoryGib float32, numVirtualCpus int32, storageGib int32) *HostClusterConfig {
	p := HostClusterConfig{}
	p.DiskIops = diskIops
...
// NewHostClusterConfigWithDefaults instantiates a new HostClusterConfig object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewHostClusterConfigWithDefaults() *HostClusterConfig {
	p := HostClusterConfig{}
	return &p
}

// GetDiskIops returns the DiskIops field value.
func (o *HostClusterConfig) GetDiskIops() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *HostClusterConfig) SetDiskIops(v int32) {
	o.DiskIops = v
}

// GetMachineType returns the MachineType field value.
func (o *HostClusterConfig) GetMachineType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *HostClusterConfig) SetMachineType(v string) {
	o.MachineType = v
}

// GetMemoryGib returns the MemoryGib field value.
func (o *HostClusterConfig) GetMemoryGib() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
func (o *HostClusterConfig) SetMemoryGib(v float32) {
	o.MemoryGib = v
}

// GetNumVirtualCpus returns the NumVirtualCpus field value.
func (o *HostClusterConfig) GetNumVirtualCpus() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *HostClusterConfig) SetNumVirtualCpus(v int32) {
	o.NumVirtualCpus = v
}

// GetStorageGib returns the StorageGib field value.
func (o *HostClusterConfig) GetStorageGib() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *HostClusterConfig) SetStorageGib(v int32) {
	o.StorageGib = v
}
