...
// HostClusterUpdateSpecification HostClusterUpdateSpecification updates a cluster that holds virtual clusters..
type HostClusterUpdateSpecification struct {
...
// NewHostClusterUpdateSpecification instantiates a new HostClusterUpdateSpecification object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewHostClusterUpdateSpecification() *HostClusterUpdateSpecification {
	p := HostClusterUpdateSpecification{}
	return &p
}

// GetCmekRegionSpecs returns the CmekRegionSpecs field value if set, zero value otherwise.
func (o *HostClusterUpdateSpecification) GetCmekRegionSpecs() []CMEKRegionSpecification {
...
func (o *HostClusterUpdateSpecification) SetCmekRegionSpecs(v []CMEKRegionSpecification) {
	o.CmekRegionSpecs = &v
}

// GetHardware returns the Hardware field value if set, zero value otherwise.
func (o *HostClusterUpdateSpecification) GetHardware() DedicatedHardwareUpdateSpecification {
...
func (o *HostClusterUpdateSpecification) SetHardware(v DedicatedHardwareUpdateSpecification) {
	o.Hardware = &v
}

// GetRegionMachineSpecs returns the RegionMachineSpecs field value if set, zero value otherwise.
func (o *HostClusterUpdateSpecification) GetRegionMachineSpecs() map[string]DedicatedMachineTypeSpecification {
...
func (o *HostClusterUpdateSpecification) SetRegionMachineSpecs(v map[string]DedicatedMachineTypeSpecification) {
	o.RegionMachineSpecs = &v
}

// GetRegionNodes returns the RegionNodes field value if set, zero value otherwise.
func (o *HostClusterUpdateSpecification) GetRegionNodes() map[string]int32 {
...
func (o *HostClusterUpdateSpecification) SetRegionNodes(v map[string]int32) {
	o.RegionNodes = &v
}
