...
// ListServiceAccountCredentialsResponse struct for ListServiceAccountCredentialsResponse.
type ListServiceAccountCredentialsResponse struct {
	// The service account's credentials, ordered by created_at.
	Credentials []ServiceAccountCredential `json:"credentials"`
...
func NewListServiceAccountCredentialsResponse(credentials []ServiceAccountCredential) *ListServiceAccountCredentialsResponse {
	p := ListServiceAccountCredentialsResponse{}
...
func (o *ListServiceAccountCredentialsResponse) GetCredentials() []ServiceAccountCredential {
	if o == nil {
		var ret []ServiceAccountCredential
		return ret
	}
