...
// ListVirtualClusterWorkspacesResponse struct for ListVirtualClusterWorkspacesResponse.
type ListVirtualClusterWorkspacesResponse struct {
	Pagination *KeysetPaginationResponse `json:"pagination,omitempty"`
	// The workspaces in the organization.
	Workspaces []VirtualClusterWorkspace `json:"workspaces"`
}
...
func NewListVirtualClusterWorkspacesResponse(workspaces []VirtualClusterWorkspace) *ListVirtualClusterWorkspacesResponse {
	p := ListVirtualClusterWorkspacesResponse{}
...
func (o *ListVirtualClusterWorkspacesResponse) GetWorkspaces() []VirtualClusterWorkspace {
	if o == nil {
		var ret []VirtualClusterWorkspace
		return ret
	}
