...
// PhysicalReplicationStreamList struct for PhysicalReplicationStreamList.
type PhysicalReplicationStreamList struct {
	...
	PhysicalReplicationStreams []PhysicalReplicationStream `json:"physical_replication_streams"`
}
...
func NewPhysicalReplicationStreamList(physicalReplicationStreams []PhysicalReplicationStream) *PhysicalReplicationStreamList {
	p := PhysicalReplicationStreamList{}
	p.PhysicalReplicationStreams = physicalReplicationStreams
	return &p
}
...
// GetPhysicalReplicationStreams returns the PhysicalReplicationStreams field value.
func (o *PhysicalReplicationStreamList) GetPhysicalReplicationStreams() []PhysicalReplicationStream {
	if o == nil {
		var ret []PhysicalReplicationStream
		return ret
	}

	return o.PhysicalReplicationStreams
}

// SetPhysicalReplicationStreams sets field value.
func (o *PhysicalReplicationStreamList) SetPhysicalReplicationStreams(v []PhysicalReplicationStream) {
	o.PhysicalReplicationStreams = v
}
