...
// SearchUserBody struct for SearchUserBody.
type SearchUserBody struct {
	Attributes         *string `json:"attributes,omitempty"`
	ExcludedAttributes *string `json:"excludedAttributes,omitempty"`
}

// NewSearchUserBody instantiates a new SearchUserBody object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewSearchUserBody() *SearchUserBody {
	p := SearchUserBody{}
	return &p
}

// GetAttributes returns the Attributes field value if set, zero value otherwise.
func (o *SearchUserBody) GetAttributes() string {
...
func (o *SearchUserBody) SetAttributes(v string) {
	o.Attributes = &v
}

// GetExcludedAttributes returns the ExcludedAttributes field value if set, zero value otherwise.
func (o *SearchUserBody) GetExcludedAttributes() string {
...
func (o *SearchUserBody) SetExcludedAttributes(v string) {
