...
type UpdateClusterSpecification struct {
	...
	Host             *HostClusterUpdateSpecification      `json:"host,omitempty"`
...
func (o *UpdateClusterSpecification) GetHost() HostClusterUpdateSpecification {
	if o == nil || o.Host == nil {
		var ret HostClusterUpdateSpecification
		return ret
	}
	return *o.Host
}

// SetHost gets a reference to the given HostClusterUpdateSpecification and assigns it to the Host field.
