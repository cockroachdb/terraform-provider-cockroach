...
type Service interface {
	...
	CreateMigrationAssistant(ctx _context.Context, clusterId string, createMigrationAssistantBody *CreateMigrationAssistantBody) (*MigrationAssistant, *_nethttp.Response, error)
	// Delete the Migration Assistant for a cluster.
	DeleteMigrationAssistant(ctx _context.Context, clusterId string) (*MigrationAssistant, *_nethttp.Response, error)
	// Delete the source-database CA certificate for a cluster&#39;s Migration Assistant.
	DeleteMigrationAssistantSourceCACert(ctx _context.Context, clusterId string) (*MigrationAssistantSourceCACert, *_nethttp.Response, error)
	// Get the Migration Assistant for a cluster.
	GetMigrationAssistant(ctx _context.Context, clusterId string) (*MigrationAssistant, *_nethttp.Response, error)
	// Get the source-database CA certificate for a cluster&#39;s Migration Assistant.
	GetMigrationAssistantSourceCACert(ctx _context.Context, clusterId string) (*MigrationAssistantSourceCACert, *_nethttp.Response, error)
	// Update the source-database CA certificate for a cluster&#39;s Migration Assistant.
	UpdateMigrationAssistantSourceCACert(ctx _context.Context, clusterId string, updateMigrationAssistantSourceCACertBody *UpdateMigrationAssistantSourceCACertBody) (*MigrationAssistantSourceCACert, *_nethttp.Response, error)
	...
	CreateVirtualCluster(ctx _context.Context, workspaceId string, createVirtualClusterBody *CreateVirtualClusterBody) (*Cluster, *_nethttp.Response, error)
	// Show details for a specific workspace
	GetVirtualClusterWorkspace(ctx _context.Context, workspaceId string) (*VirtualClusterWorkspace, *_nethttp.Response, error)
	// List workspaces in the organization
	ListVirtualClusterWorkspaces(ctx _context.Context, options *ListVirtualClusterWorkspacesOptions) (*ListVirtualClusterWorkspacesResponse, *_nethttp.Response, error)
	// Update a specific virtual cluster
	UpdateVirtualCluster(ctx _context.Context, workspaceId string, clusterId string, updateVirtualClusterSpecification *UpdateVirtualClusterSpecification) (*Cluster, *_nethttp.Response, error)
	// Update the configuration of a specific workspace
	UpdateVirtualClusterWorkspace(ctx _context.Context, workspaceId string, updateVirtualClusterWorkspaceSpecification *UpdateVirtualClusterWorkspaceSpecification) (*VirtualClusterWorkspace, *_nethttp.Response, error)
}
...
// CreateMigrationAssistant executes the request.
func (a *ServiceImpl) CreateMigrationAssistant(
	ctx _context.Context, clusterId string, createMigrationAssistantBody *CreateMigrationAssistantBody,
) (*MigrationAssistant, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v1/clusters/{cluster_id}/migration-assistant"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", _neturl.PathEscape(parameterToString(clusterId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if createMigrationAssistantBody == nil {
		return nil, nil, reportError("createMigrationAssistantBody is required and must be specified")
	}
	...
	// Body params.
	localVarPostBody = createMigrationAssistantBody
	req, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, nil, err
	}
	...
	var localVarReturnValue MigrationAssistant
	err = a.client.decode(&localVarReturnValue, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
	if err != nil {
		newErr := Error{
			body:  localVarBody,
...
// DeleteMigrationAssistant executes the request.
func (a *ServiceImpl) DeleteMigrationAssistant(
	ctx _context.Context, clusterId string,
) (*MigrationAssistant, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
...
// DeleteMigrationAssistantSourceCACert executes the request.
func (a *ServiceImpl) DeleteMigrationAssistantSourceCACert(
	ctx _context.Context, clusterId string,
) (*MigrationAssistantSourceCACert, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v1/clusters/{cluster_id}/migration-assistant/source-ca-cert"
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", _neturl.PathEscape(parameterToString(clusterId, "")), -1)
	...
	var localVarReturnValue MigrationAssistantSourceCACert
	err = a.client.decode(&localVarReturnValue, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
	if err != nil {
		newErr := Error{
			body:  localVarBody,
...
// GetMigrationAssistant executes the request.
func (a *ServiceImpl) GetMigrationAssistant(
	ctx _context.Context, clusterId string,
) (*MigrationAssistant, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
...
// GetMigrationAssistantSourceCACert executes the request.
func (a *ServiceImpl) GetMigrationAssistantSourceCACert(
	ctx _context.Context, clusterId string,
) (*MigrationAssistantSourceCACert, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
...
// UpdateMigrationAssistantSourceCACert executes the request.
func (a *ServiceImpl) UpdateMigrationAssistantSourceCACert(
	ctx _context.Context, clusterId string, updateMigrationAssistantSourceCACertBody *UpdateMigrationAssistantSourceCACertBody,
) (*MigrationAssistantSourceCACert, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if updateMigrationAssistantSourceCACertBody == nil {
		return nil, nil, reportError("updateMigrationAssistantSourceCACertBody is required and must be specified")
	}
	...
	// Body params.
	localVarPostBody = updateMigrationAssistantSourceCACertBody
	req, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, nil, err
	}
...
// CreateVirtualCluster executes the request.
func (a *ServiceImpl) CreateVirtualCluster(
	ctx _context.Context, workspaceId string, createVirtualClusterBody *CreateVirtualClusterBody,
) (*Cluster, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
	...
	localVarPath := localBasePath + "/api/v1/virtual-cluster-workspaces/{workspace_id}/clusters"
	localVarPath = strings.Replace(localVarPath, "{"+"workspace_id"+"}", _neturl.PathEscape(parameterToString(workspaceId, "")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if createVirtualClusterBody == nil {
		return nil, nil, reportError("createVirtualClusterBody is required and must be specified")
	}
	...
	// Body params.
	localVarPostBody = createVirtualClusterBody
	req, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, nil, err
	}
...
// GetVirtualClusterWorkspace executes the request.
func (a *ServiceImpl) GetVirtualClusterWorkspace(
	ctx _context.Context, workspaceId string,
) (*VirtualClusterWorkspace, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v1/virtual-cluster-workspaces/{workspace_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"workspace_id"+"}", _neturl.PathEscape(parameterToString(workspaceId, "")), -1)
	...
	var localVarReturnValue VirtualClusterWorkspace
	err = a.client.decode(&localVarReturnValue, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
	if err != nil {
		newErr := Error{
			body:  localVarBody,
...
// ListVirtualClusterWorkspacesOptions contains optional parameters for ListVirtualClusterWorkspaces.
type ListVirtualClusterWorkspacesOptions struct {
	PaginationPage *string
...
// ListVirtualClusterWorkspaces executes the request.
func (a *ServiceImpl) ListVirtualClusterWorkspaces(
	ctx _context.Context, options *ListVirtualClusterWorkspacesOptions,
) (*ListVirtualClusterWorkspacesResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath := localBasePath + "/api/v1/virtual-cluster-workspaces"
	...
	var localVarReturnValue ListVirtualClusterWorkspacesResponse
	err = a.client.decode(&localVarReturnValue, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
	if err != nil {
		newErr := Error{
			body:  localVarBody,
...
// UpdateVirtualCluster executes the request.
func (a *ServiceImpl) UpdateVirtualCluster(
	ctx _context.Context, workspaceId string, clusterId string, updateVirtualClusterSpecification *UpdateVirtualClusterSpecification,
) (*Cluster, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
	...
	localVarPath := localBasePath + "/api/v1/virtual-cluster-workspaces/{workspace_id}/clusters/{cluster_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"workspace_id"+"}", _neturl.PathEscape(parameterToString(workspaceId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"cluster_id"+"}", _neturl.PathEscape(parameterToString(clusterId, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if updateVirtualClusterSpecification == nil {
		return nil, nil, reportError("updateVirtualClusterSpecification is required and must be specified")
	}
	...
	// Body params.
	localVarPostBody = updateVirtualClusterSpecification
	req, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, nil, err
	}
...
// UpdateVirtualClusterWorkspace executes the request.
func (a *ServiceImpl) UpdateVirtualClusterWorkspace(
	ctx _context.Context, workspaceId string, updateVirtualClusterWorkspaceSpecification *UpdateVirtualClusterWorkspaceSpecification,
) (*VirtualClusterWorkspace, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPatch
		localVarPostBody     interface{}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if updateVirtualClusterWorkspaceSpecification == nil {
		return nil, nil, reportError("updateVirtualClusterWorkspaceSpecification is required and must be specified")
	}
	...
	// Body params.
	localVarPostBody = updateVirtualClusterWorkspaceSpecification
	req, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return nil, nil, err
	}
