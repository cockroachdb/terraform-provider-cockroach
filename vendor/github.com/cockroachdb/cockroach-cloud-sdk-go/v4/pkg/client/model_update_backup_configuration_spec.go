...
type UpdateBackupConfigurationSpec struct {
	// Indicates whether the backup configuration is enabled and can run. If set to true, frequency_minutes and retention_days must be set or will be inherited from the last enabled configuration.
	Enabled *bool `json:"enabled,omitempty"`
	// The frequency of backups in minutes. Can be one of [5, 10, 15, 30, 60, 240, 1440].
	FrequencyMinutes *int32 `json:"frequency_minutes,omitempty"`
	// The number of days to retain backups for. Can be one of [2, 7, 30, 90, 365]. Can only be set once, further changes require opening a support ticket.
